...
public class JTableExample {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            table.getSelectionModel().addListSelectionListener(e -> selecionarVacina(table, e));
    ...
    private static void selecionarVacina(JTable table, ListSelectionEvent e) {
        if (!e.getValueIsAdjusting()) {
            ...
            if (selectedRow != -1) {
                ...
                System.out.println("ID: " + id + ", Nome: " + nome + ", Descricao: " + diretor);
            }
        }
    }
    ...
    private static void fillTable(JTable table) {
        ...
        String url = "jdbc:mysql://localhost:3306/hackathon_vacina?useTimezone=true&serverTimezone=UTC";
        String user = "root";
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password)) {
            ...
            try (PreparedStatement statement = connection.prepareStatement(sql)) {
                ...
                while (resultSet.next()) {
                    ...
                    String diretor = resultSet.getString("descricao");
