...
public class VacinaService extends JFrame {

    private Vacina service;
    ...
    public VacinaService(JFrame mainForm) {
        this.mainForm = mainForm;
        service = new Vacina(VacinaService);
    ...
    private void painelEntrada(GridBagConstraints constraints, JPanel painelEntrada) {
        ...
        labelNomeVacina = new JLabel("Nome do Filme:");
        constraints.gridx = 0;
        constraints.gridy = 1;
        ...
        labelDescricao = new JLabel("Diretor do Filme:");
        constraints.gridx = 0;
        constraints.gridy = 2;
        ...
        botaoSalvar.addActionListener(e -> salvar(construirVacina()));
        constraints.gridx = 0;
        constraints.gridy = 3;
    ...
    private DefaultTableModel carregarDadoshackathon() {
        ...
        service.salvar().forEach(vacina -> model.addRow(new Object[]{vacina.getId(), vacina.getNome(), vacina.getDescricao()}));
        return model;
    }

    private void salvar(Vacina vacina) {
